...
import { repositionBalloons, killBaloon } from '../actions/balloon.actions';
...
class Amuse extends Component {
  ...
  render() {
    ...
    const Balloons = map(balloons.data, (balloon, key) => <Balloon kill={killBaloon} position={balloon.position} key={key}></Balloon>);
